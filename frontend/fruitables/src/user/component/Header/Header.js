              ...
              <div className={`collapse navbar-collapse ${themeContext.theme}`} id="navbarCollapse">
                ...
                <div className={`d-flex m-3 me-0 ${themeContext.theme}`}>
                  ...
                  <NavLink to={"/Card"} href="#" className="position-relative me-4 my-auto">
                    ...
                    <span to={"/Card"} className="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1" style={{ top: '-5px', left: 15, height: 20, minWidth: 20 }}>{totalQuantity}</span>
                  </NavLink>
